...
import jp.ryo.informationPump.server.db.results.webdatadbmanager.SelectEntriesAfterADateResult;
import jp.crossfire.framework.database.ISelectResultListener;

public class WebDataDBManagerSelectEntriesAfterADateListner implements ISelectResultListener {
	...
	public  WebDataDBManagerSelectEntriesAfterADateListner() {
		Hashtable hash = null;
		hash = new Hashtable();
	...
	public void orMap() {
		...
		while(it.hasNext()){
			...
			SelectEntriesAfterADateResult data = (SelectEntriesAfterADateResult)it.next();
	...
	public void getResult(ResultSet result, ResultSetMetaData meta) throws Exception {
		...
		SelectEntriesAfterADateResult data = new SelectEntriesAfterADateResult();
