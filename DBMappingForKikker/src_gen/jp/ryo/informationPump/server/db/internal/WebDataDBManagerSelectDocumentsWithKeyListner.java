...
import jp.ryo.informationPump.server.db.results.webdatadbmanager.SelectDocumentsWithKeyResult;
import jp.crossfire.framework.database.ISelectResultListener;

public class WebDataDBManagerSelectDocumentsWithKeyListner implements ISelectResultListener {
	...
	public  WebDataDBManagerSelectDocumentsWithKeyListner() {
		Hashtable hash = null;
		hash = new Hashtable();
	...
	public void orMap() {
		...
		while(it.hasNext()){
			...
			SelectDocumentsWithKeyResult data = (SelectDocumentsWithKeyResult)it.next();
	...
	public void getResult(ResultSet result, ResultSetMetaData meta) throws Exception {
		...
		SelectDocumentsWithKeyResult data = new SelectDocumentsWithKeyResult();
