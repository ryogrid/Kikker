...
import jp.ryo.informationPump.server.db.results.webdatadbmanager.SelectDocumentsWithKeyAndDateResult;
import jp.crossfire.framework.database.ISelectResultListener;

public class WebDataDBManagerSelectDocumentsWithKeyAndDateListner implements ISelectResultListener {
	...
	public  WebDataDBManagerSelectDocumentsWithKeyAndDateListner() {
		Hashtable hash = null;
		hash = new Hashtable();
	...
	public void orMap() {
		...
		while(it.hasNext()){
			...
			SelectDocumentsWithKeyAndDateResult data = (SelectDocumentsWithKeyAndDateResult)it.next();
	...
	public void getResult(ResultSet result, ResultSetMetaData meta) throws Exception {
		...
		SelectDocumentsWithKeyAndDateResult data = new SelectDocumentsWithKeyAndDateResult();
